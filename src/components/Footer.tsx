...
const Footer = () => {
  ...
  return (
    <footer className="bg-school-blue text-white mt-auto">
      {/* Main Footer Content */}
      <div className="py-8">
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <div className="space-y-1">
                    <div className="text-school-blue-light">{contactInfo.phone}</div>
                    {contactInfo.phone2 && <div className="text-school-blue-light">{contactInfo.phone2}</div>}
                    {contactInfo.phone3 && <div className="text-school-blue-light">{contactInfo.phone3}</div>}
                    {contactInfo.phone4 && <div className="text-school-blue-light">{contactInfo.phone4}</div>}
                    {contactInfo.phone5 && <div className="text-school-blue-light">{contactInfo.phone5}</div>}
                  </div>
                </div>
                <div className="flex items-center gap-2">
      ...
      <div className="py-4 border-t border-white/20">
        <div className="container mx-auto px-4 text-center">
          <p className="text-xs text-school-blue-light">
